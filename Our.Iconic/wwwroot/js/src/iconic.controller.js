angular.module("umbraco")
    .controller("Our.Iconic.Controller", ['$scope', '$http', 'assetsService', 'umbRequestHelper', 'editorService',
        function($scope, $http, assetsService, umbRequestHelper, editorService) {
            ...
            $scope.selectIcon = function(model) {
                if (model.icon && model.packageId) {
                    $scope.pckg = loadPackage($scope.model.config.packages, model.packageId);
            ...
            function initPicker() {
                ...
                if ($scope.model.value && $scope.model.value.packageId && $scope.model.value.icon) {
                    ...
                    $scope.pckg = loadPackage($scope.model.config.packages, $scope.model.value.packageId);
                    if ($scope.pckg) {
